...
| Ticket | Summary |
|--------|---------|
| T1 | Initialized Cargo project with clap, thiserror, memmap2 |
| T2 | Implemented 2-bit encoded Reference with FASTA parser |
| T3 | Built sort-based Suffix Array construction (O(n² log n)) |
| T4 | Constructed BWT from suffix array |
| T5 | Implemented FM-Index with backward search and OCC counts |
| T6 | Added FM-Index save/load with memory-mapped files |
| T7 | Implemented recursive backward search |
| T8 | Built MEM discovery with configurable min_seed_len |
